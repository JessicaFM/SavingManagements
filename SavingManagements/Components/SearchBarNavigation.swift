...
//  SavingManagements
//
//  Created by Jessica F on 11/5/21.
//
import SwiftUI

struct SearchBarNavigation<Content: View>: UIViewControllerRepresentable  {
    @Binding var text: String
       ...
       class Coordinator: NSObject, UISearchBarDelegate {
           ...
           init(content: Content, searchText: Binding<String>, searchAction: @escaping () -> Void, cancelAction: @escaping () -> Void) {
               ...
               searchController.obscuresBackgroundDuringPresentation = true  // false
